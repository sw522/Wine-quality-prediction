...
public class Predict {
    ...
    public static void main(String[] args) {
        ...
        if(exists){
            ...
            System.out.print("TestDataset.csv doesn't exists please provide testFilePath using -v \n" +
                    "docker run -v docker run -v /path/on/host/machine/TestDataset.csv:/data/TestDataset.csv walsh13/wine-" +
    ...
    public void logisticRegression(SparkSession spark) {
        ...
        predictionDF.select("features", "label", "prediction").show(20, false);
